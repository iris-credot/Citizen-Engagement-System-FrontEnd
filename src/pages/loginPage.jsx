...
export default function Login() {
        ...
        <div className=" w-full flex justify-center  h-[80%]">
          <div className="p-6 w-full h-full flex flex-col max-w-md overflow-auto md:overflow-visible">
            <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col items-start gap-2">
              ...
              <button
                type="submit"
                className="mt-10 md:mt-4 p-2 bg-[#FFB640] text-white rounded-md hover:bg-[#b67d22] transition duration-200 w-full max-w-md" 
  ...
  <div className="flex gap-1">
    <p>New User?</p>
    <p className="text-[#FFB640] hover:underline cursor-pointer"onClick={() => navigate("/signup")}>Signup</p>
  </div>
  <p className="text-[#FFB640] hover:underline cursor-pointer"onClick={() => navigate("/forgotpass")}>Forgot your password?</p>
</div>
          </div>
        </div>
      </div>
