  ...
  const onSubmit = (data) => {
    ...
    return(
        ...
        <div className="md:bg-[#f3f5ff] h-screen overflow-auto flex md:items-center  md:justify-center w-screen md:p-0 p-6 ">
          <div className="w-full max-w-4xl h-screen  bg-white rounded-xl flex   p-2 md:gap-1 gap-14 ">
...
<label htmlFor="agency_id" className="text-sm font-medium text-gray-700">Agency</label>
<select
  {...register("agency_id")}
  name="agency_id"
...
>
  ...
  <option value="agency123">Ministry of Health</option>
  <option value="agency456">Ministry of Education</option>
  <option value="agency789">Ministry of Environment</option>
</select>
{errors.agency_id && (
